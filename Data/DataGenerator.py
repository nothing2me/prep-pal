...
def generate_data(num_records):
    ...
    for _ in range(num_records):
        ...
        # Course scores (random numbers between 0 and 400)
        math_score = random.randint(300, 400)
        reading_score = random.randint(300, 400)
        writing_score = random.randint(300, 400)
        ...
        data_record = f"A0{student_id:07},email@islander.tamucc.edu,{last_name},{first_name},{transfer_status}," \
                      f"{attempted_hours:03},{math_tsi_attempts:02},{reading_tsi_attempts:02},{math_score:03},{reading_score:03},{writing_score:03},{violations:02}"
